...
- **⏰ Aviso de rotación cada 2 meses**: la rotación sigue siendo manual, pero a las 8 **semanas entrenadas** salta una alerta (una vez por semana) recordando rotar, y en Ajustes se ve el avance ("Semanas entrenadas: 5 de 8"). Solo cuentan las semanas con **más de 3 días** de entrenamiento, así que una primera semana a medias, un viaje o una enfermedad no adelantan el aviso. Después de rotar, durante esa semana y la siguiente el reporte del día muestra los pesos de los ejercicios anteriores como referencia; en el historial quedan guardados siempre.
